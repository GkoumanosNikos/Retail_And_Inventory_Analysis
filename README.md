...
## Project Overview
SQL, PowerBI analysis of Retail Company. The project aims to examine several outcomes about sales, revenues, inventory of Maven Toys company. Also, the project includes reccomendations about the future investments of the company, while three additional mini case-study scenarios follow at the end for further conclusions. 
...
This query combines the 5 most profitables stores and categories. The outcomes show the categories of profucts that every store make the most revenues. This outcomes also can help the company to understand the demand of each category in order to make more campaignes. Moreover, it is helpful in terms of investment. The company should take into account the most profitable categories and invest more to them. Further, the categories that they dont make a lot of money to the company should be reconsidered.
